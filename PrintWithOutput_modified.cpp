...
// ============================================
int main() {
    std::cout << "=== XXML Print Demo ===\n";
    using namespace Language::Core;
    
    Language::Core::String greeting = Language::Core::String("Hello from XXML!");
    std::cout << "Greeting created successfully!\n";
    ...
    std::cout << "Sum calculated successfully!\n";
}
