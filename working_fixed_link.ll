...
; ============================================
@.str.0 = private unnamed_addr constant [27 x i8] c"Testing XXML LLVM Compiler\00"
@.str.1 = private unnamed_addr constant [24 x i8] c"Addition test complete!\00"
...
define i32 @main() #1 {
    ...
    %r2 = alloca ptr
    %r3 = call ptr @Integer_Constructor(i64 32)
    store ptr %r3, ptr %r2
    ...
    %r8 = alloca ptr
    %r9 = load ptr, ptr %r4
    %r10 = call ptr @Integer_toString(ptr %r9)
    store ptr %r10, ptr %r8
    %r11 = call ptr @String_Constructor(ptr @.str.0)
    %r12 = call ptr @Console_printLine(ptr %r11)
    %r13 = load ptr, ptr %r8
    %r14 = call ptr @Console_printLine(ptr %r13)
    %r15 = call ptr @String_Constructor(ptr @.str.1)
    %r16 = call ptr @Console_printLine(ptr %r15)
    ret i32 0
}
