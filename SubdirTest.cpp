...
// ============================================
// Module: .::MyProject::Utils::Calculator
// ============================================
class Calculator {
    public:
        Calculator() {
        }
        static Calculator Constructor() { return Calculator(); }
};
...
int main() {
    ...
    System::Console::printLine(Language::Core::String("=== Subdirectory Import Test ==="));
    std::unique_ptr<Calculator> calc = std::make_unique<Calculator>();
    System::Console::printLine(Language::Core::String("Calculator created from imported module!"));
