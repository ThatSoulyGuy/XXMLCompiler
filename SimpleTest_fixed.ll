...
; ============================================
@.str.0 = private unnamed_addr constant [27 x i8] c"Hello from LLVM toolchain!\00"

; import Language::Core
define i32 @main() #1 {
    %r0 = call ptr @String_Constructor(i64 @.str.0)
    %r1 = call ptr @Console_printLine(ptr %r0)
    ret i32 0
}
