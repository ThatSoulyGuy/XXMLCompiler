...
namespace Language::Core {
    ...
    Language::Runtime::Owned<Language::Core::String> Language::Core::String::FromCString(void* ptr) {
        Language::Runtime::Owned<void*> strPtr = Syscall::string_create(ptr);
    ...
    Language::Runtime::Owned<Language::Core::String> Language::Core::String::charAt(Language::Core::Integer& index) {
        Language::Runtime::Owned<void*> ptr(data.get());
        Language::Runtime::Owned<int64_t> idx(index.get());
        Language::Runtime::Owned<const void*> charCStr = Syscall::string_charAt(std::move(ptr), std::move(idx));
...
namespace Collections {
    ...
    class HashMap {
        private:
            Language::Runtime::Owned<void*> bucketsPtr;
            Language::Runtime::Owned<void*> capacity;
            Language::Runtime::Owned<void*> count;
        public:
            HashMap() = default;
            void init() {
                Language::Runtime::Owned<int64_t> initialCap = 16;
                Language::Runtime::Owned<int64_t> size = initialCap * 8;
                Language::Runtime::Owned<void*> ptr = Syscall::malloc(std::move(size));
                Syscall::memset(std::move(ptr), 0, std::move(size));
                Syscall::memcpy(&bucketsPtr, &ptr, 8);
                Syscall::memcpy(&capacity, &initialCap, 8);
                Language::Runtime::Owned<int64_t> zero = 0;
            ...
            void put(Language::Runtime::Owned<Language::Core::String> key, Language::Runtime::Owned<Language::Core::String> value) {
                Language::Runtime::Owned<int64_t> currentCap(capacity.get());
                Language::Runtime::Owned<int64_t> hashVal = hashString(std::move(key));
                Language::Runtime::Owned<int64_t> bucketIndex = hashVal % currentCap;
                Language::Runtime::Owned<void*> currentBucketsPtr(bucketsPtr.get());
                Language::Runtime::Owned<int64_t> offset = bucketIndex * 8;
                Language::Runtime::Owned<void*> bucketPos = currentBucketsPtr + offset;
                Language::Runtime::Owned<void*> headPtr = Syscall::read_int64(std::move(bucketPos));
                if (headPtr == 0) {
                    createNode(std::move(bucketPos), std::move(key), std::move(value));
                    Language::Runtime::Owned<int64_t> currentCount(count.get());
                    Language::Runtime::Owned<int64_t> newCount = currentCount + 1;
            ...
            Language::Runtime::Owned<Language::Core::Bool> containsKey(Language::Runtime::Owned<Language::Core::String> key) {
                ...
                Language::Runtime::Owned<int64_t> len = result->length();
                if (len == 0) {
                    return Language::Core::Bool(false);
                } else {
                    return Language::Core::Bool(true);
        ...
        private:
            int64_t hashString(Language::Runtime::Owned<Language::Core::String> str) {
                Language::Runtime::Owned<int64_t> len = str->length();
            ...
            int64_t hashHelper(Language::Runtime::Owned<Language::Core::String> str, Language::Core::Integer& index, Language::Runtime::Owned<Language::Core::Integer> hash, Language::Runtime::Owned<Language::Core::Integer> len) {
                Language::Runtime::Owned<int64_t> idx(index.get());
                Language::Runtime::Owned<int64_t> length(len.get());
                if (idx >= length) {
                    Language::Runtime::Owned<int64_t> result(hash.get());
                    if (result < 0) {
                        Language::Runtime::Owned<int64_t> negOne = 0 - 1;
                ...
                Language::Runtime::Owned<void*> charCStr = charStr->toCString();
                Language::Runtime::Owned<int64_t> charVal = Syscall::read_int64(std::move(charCStr));
                Language::Runtime::Owned<int64_t> currentHash(hash.get());
                Language::Runtime::Owned<int64_t> newHash = currentHash * 33 + charVal;
            ...
            void createNode(void* bucketPos, Language::Runtime::Owned<Language::Core::String> key, Language::Runtime::Owned<Language::Core::String> value) {
                Language::Runtime::Owned<int64_t> nodeSize = 24;
                Language::Runtime::Owned<void*> nodePtr = Syscall::malloc(std::move(nodeSize));
                Language::Runtime::Owned<int64_t> keyLen = key->length();
                Language::Runtime::Owned<int64_t> keyAllocSize = keyLen + 1;
                Language::Runtime::Owned<void*> keyCopy = Syscall::malloc(std::move(keyAllocSize));
                Language::Runtime::Owned<void*> keySrc = key->toCString();
                Syscall::memcpy(std::move(keyCopy), std::move(keySrc), std::move(keyLen));
                Language::Runtime::Owned<void*> keyNullPos = keyCopy + keyLen;
                Language::Runtime::Owned<int64_t> zero = 0;
                Syscall::write_int64(std::move(keyNullPos), std::move(zero));
                Language::Runtime::Owned<int64_t> valueLen = value->length();
                Language::Runtime::Owned<int64_t> valueAllocSize = valueLen + 1;
                Language::Runtime::Owned<void*> valueCopy = Syscall::malloc(std::move(valueAllocSize));
                Language::Runtime::Owned<void*> valueSrc = value->toCString();
                Syscall::memcpy(std::move(valueCopy), std::move(valueSrc), std::move(valueLen));
                Language::Runtime::Owned<void*> valueNullPos = valueCopy + valueLen;
                Syscall::write_int64(std::move(valueNullPos), std::move(zero));
                Syscall::write_int64(std::move(nodePtr), std::move(keyCopy));
                Language::Runtime::Owned<void*> valuePos = nodePtr + 8;
                Syscall::write_int64(std::move(valuePos), std::move(valueCopy));
                Language::Runtime::Owned<void*> nextPos = nodePtr + 16;
            ...
            void putInChain(void* nodePtr, void* bucketPos, Language::Runtime::Owned<Language::Core::String> key, Language::Runtime::Owned<Language::Core::String> value) {
                Language::Runtime::Owned<void*> keyPtr = Syscall::read_int64(nodePtr);
                Language::Runtime::Owned<Language::Core::String> nodeKey = String::FromCString(std::move(keyPtr));
                if (nodeKey == key) {
                    Language::Runtime::Owned<void*> valuePos = nodePtr + 8;
                    Language::Runtime::Owned<void*> oldValuePtr = Syscall::read_int64(std::move(valuePos));
                    ...
                    Language::Runtime::Owned<void*> nextPos = nodePtr + 16;
                    Language::Runtime::Owned<void*> nextPtr = Syscall::read_int64(std::move(nextPos));
                    if (nextPtr == 0) {
            ...
            void createNodeInChain(void* nextPos, Language::Runtime::Owned<Language::Core::String> key, Language::Runtime::Owned<Language::Core::String> value) {
                ...
                Language::Runtime::Owned<void*> valuePos = nodePtr + 8;
                Syscall::write_int64(std::move(valuePos), std::move(valueCopy));
                Language::Runtime::Owned<void*> nextPtrPos = nodePtr + 16;
            ...
            Language::Runtime::Owned<Language::Core::String> findValueInChain(void* nodePtr, Language::Runtime::Owned<Language::Core::String> key) {
                ...
                if (nodeKey == key) {
                    Language::Runtime::Owned<void*> valuePos = nodePtr + 8;
                    Language::Runtime::Owned<void*> valuePtr = Syscall::read_int64(std::move(valuePos));
            ...
            void disposeBuckets(Language::Core::Integer& index) {
                ...
                Language::Runtime::Owned<void*> currentBucketsPtr(bucketsPtr.get());
                Language::Runtime::Owned<int64_t> offset = idx * 8;
                Language::Runtime::Owned<void*> bucketPos = currentBucketsPtr + offset;
                Language::Runtime::Owned<void*> headPtr = Syscall::read_int64(std::move(bucketPos));
                if (headPtr != 0) {
...
int main() {
    ...
    Language::Runtime::Owned<Language::Core::String> message = Language::Core::String("Import system works!");
    Console::printLine(std::move(message));
    Language::Runtime::Owned<Language::Core::Integer> num = Language::Core::Integer(42);
    Language::Runtime::Owned<Language::Core::String> numStr = num->toString();
    Console::print(Language::Core::String("Number: "));
    Console::printLine(std::move(numStr));
    Language::Runtime::Owned<Language::Core::Bool> flag = Language::Core::Bool(true);
    Console::printLine(Language::Core::String("Bool test passed"));
    Console::printLine(Language::Core::String("✓ All imports working correctly!"));
}
