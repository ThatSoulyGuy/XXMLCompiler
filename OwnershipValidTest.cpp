    ...
    class RefTest {
        public:
            ...
            void modifyRef(Language::Core::Integer& num) {
                ...
                System::Console::printLine(Language::Core::String("Inside modifyRef, set num to 777"));
            }
            void takeOwnership(Language::Runtime::Owned<Language::Core::Integer> num) {
                System::Console::printLine(Language::Core::String("Took ownership of Integer"));
            }
        private:
    };
...
int main() {
    ...
    System::Console::printLine(Language::Core::String("=== Ownership Validation Test ==="));
    Language::Runtime::Owned<Language::Core::Integer> num1 = Language::Core::Integer(42);
    System::Console::printLine(Language::Core::String("Created owned Integer: 42"));
    Language::Core::Integer& num1Ref = num1;
    System::Console::printLine(Language::Core::String("Created reference to num1"));
    Language::Runtime::Owned<Test::RefTest> tester = Test::RefTest();
    Language::Runtime::Owned<Language::Core::Integer> testNum = Language::Core::Integer(50);
    System::Console::printLine(Language::Core::String("Original value: 50"));
    tester->modifyRef(std::move(testNum));
    System::Console::printLine(Language::Core::String("After modifyRef, value should be 777"));
    Language::Runtime::Owned<Language::Core::Integer> testNum2 = Language::Core::Integer(100);
    tester->takeOwnership(std::move(testNum2));
    System::Console::printLine(Language::Core::String("Passed ownership to method"));
