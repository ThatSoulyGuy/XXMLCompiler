...
int main() {
    ...
    Language::Core::String greeting = Language::Core::String("Hello, XXML!");
    Language::Core::String name = Language::Core::String("Developer");
    Language::Core::String message = Language::Core::String("Welcome to XXML programming");
    Language::Core::Integer answerToLife = Language::Core::Integer(42);
    Language::Core::Integer multiplier = Language::Core::Integer(2);
    Language::Core::Integer result = answerToLife.multiply(multiplier);
    Language::Core::String combined = Language::Core::String("Hello");
    Language::Core::String space = Language::Core::String(" ");
    Language::Core::String world = Language::Core::String("World!");
    combined.append(space);
    combined.append(world);
    Language::Core::Integer length = combined.length();
    Language::Core::Integer num1 = Language::Core::Integer(100);
    Language::Core::Integer num2 = Language::Core::Integer(50);
    Language::Core::Bool isGreater = num1.greaterThan(num2);
    Language::Core::Bool isEqual = num1.equals(num2);
    Language::Core::Integer a = Language::Core::Integer(15);
    Language::Core::Integer b = Language::Core::Integer(7);
    Language::Core::Integer sum = a.add(b);
    Language::Core::Integer diff = a.subtract(b);
    Language::Core::Integer prod = a.multiply(b);
    Language::Core::Integer quot = a.divide(b);
    Language::Core::Integer mod = a.modulo(b);
    Language::Core::String original = Language::Core::String("Test String");
    Language::Core::String copy = original.copy();
    Language::Core::Bool areEqual = original.equals(copy);
}
