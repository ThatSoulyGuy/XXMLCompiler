...
int main() {
    ...
    System::Console::printLine(Language::Core::String("=== Set Statement Test ==="));
    Language::Runtime::Owned<Language::Core::Integer> num = Language::Core::Integer(42);
    System::Console::printLine(Language::Core::String("Initial value: 42"));
    num = Language::Core::Integer(100);
    System::Console::printLine(Language::Core::String("After Set: should be 100"));
    Language::Runtime::Owned<Language::Core::String> text = Language::Core::String("Hello");
    System::Console::printLine(Language::Core::String("Initial text: Hello"));
    text = Language::Core::String("World");
    System::Console::printLine(Language::Core::String("After Set: should be World"));
    Language::Runtime::Owned<Language::Core::Integer> counter = Language::Core::Integer(0);
    counter = Language::Core::Integer(1);
    counter = Language::Core::Integer(2);
    counter = Language::Core::Integer(3);
    System::Console::printLine(Language::Core::String("Counter after multiple sets: should be 3"));
    System::Console::printLine(Language::Core::String("✓ All Set tests completed!"));
}
