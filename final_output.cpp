...
int main() {
    ...
    System::Console::printLine(Language::Core::String("=== XXML Comprehensive Console Test ==="));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("Test 1: Basic Output"));
    System::Console::print(Language::Core::String("Hello from "));
    System::Console::printLine(Language::Core::String("XXML!"));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("Test 2: Integer Operations"));
    Language::Core::Integer num1 = Language::Core::Integer(42);
    Language::Core::Integer num2 = Language::Core::Integer(8);
    Language::Core::Integer sum = Language::Core::Integer(50);
    System::Console::print(Language::Core::String("Created integers: 42 and 8"));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("Test 3: String Operations"));
    Language::Core::String greeting = Language::Core::String("Hello");
    Language::Core::String name = Language::Core::String("World");
    System::Console::print(Language::Core::String("Created strings!"));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("Test 4: Boolean Operations"));
    Language::Core::Bool flag1 = Language::Core::Bool(true);
    Language::Core::Bool flag2 = Language::Core::Bool(false);
    System::Console::printLine(Language::Core::String("Created booleans!"));
    System::Console::printLine(Language::Core::String(""));
