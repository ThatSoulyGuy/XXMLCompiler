...
namespace Test {
    ...
    class Tester {
        public:
            Tester() = default;
            void modifyCopy(Language::Core::Integer num) {
                System::Console::printLine(Language::Core::String("  [modifyCopy] Received copy, modifying to 999"));
                num = Language::Core::Integer(999);
                System::Console::printLine(Language::Core::String("  [modifyCopy] Local copy is now 999"));
            }
            void modifyRef(Language::Core::Integer& num) {
                System::Console::printLine(Language::Core::String("  [modifyRef] Received reference, modifying to 777"));
                num = Language::Core::Integer(777);
                System::Console::printLine(Language::Core::String("  [modifyRef] Reference updated to 777"));
            }
            void takeOwnership(Language::Runtime::Owned<Language::Core::Integer> num) {
                System::Console::printLine(Language::Core::String("  [takeOwnership] Took ownership of Integer"));
                System::Console::printLine(Language::Core::String("  [takeOwnership] Value is now owned by this method"));
            }
            Language::Runtime::Owned<Language::Core::Integer> createInteger() {
                Language::Runtime::Owned<Language::Core::Integer> result = Language::Core::Integer(12345);
                System::Console::printLine(Language::Core::String("  [createInteger] Returning owned Integer(12345)"));
                return std::move(result);
            }
            Language::Runtime::Owned<Language::Core::Integer> createIntegerDirect() {
                System::Console::printLine(Language::Core::String("  [createIntegerDirect] Returning Integer(54321)"));
                return Language::Core::Integer(54321);
            }
        private:
    };
...
int main() {
    ...
    System::Console::printLine(Language::Core::String("=== Copy, Reference, and Move Semantics Test ==="));
    System::Console::printLine(Language::Core::String(""));
    Language::Runtime::Owned<Test::Tester> tester = Test::Tester();
    System::Console::printLine(Language::Core::String("TEST 1: Copy Parameter (Integer%)"));
    Language::Runtime::Owned<Language::Core::Integer> num1 = Language::Core::Integer(100);
    System::Console::printLine(Language::Core::String("Before modifyCopy: num1 = 100"));
    tester->modifyCopy(std::move(num1));
    System::Console::printLine(Language::Core::String("After modifyCopy: num1 should still be 100 (unchanged)"));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("TEST 2: Reference Parameter (Integer&)"));
    Language::Runtime::Owned<Language::Core::Integer> num2 = Language::Core::Integer(200);
    System::Console::printLine(Language::Core::String("Before modifyRef: num2 = 200"));
    tester->modifyRef(std::move(num2));
    System::Console::printLine(Language::Core::String("After modifyRef: num2 should be 777 (modified)"));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("TEST 3: Owned Parameter (Integer^) - Move Semantics"));
    Language::Runtime::Owned<Language::Core::Integer> num3 = Language::Core::Integer(300);
    System::Console::printLine(Language::Core::String("Before takeOwnership: num3 = 300"));
    tester->takeOwnership(std::move(num3));
    System::Console::printLine(Language::Core::String("After takeOwnership: num3 has been moved (ownership transferred)"));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("TEST 4: Returning Owned Values"));
    Language::Runtime::Owned<Language::Core::Integer> num4 = tester->createInteger();
    System::Console::printLine(Language::Core::String("Received returned value: 12345"));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("TEST 5: Returning Owned Values (Direct)"));
    Language::Runtime::Owned<Language::Core::Integer> num5 = tester->createIntegerDirect();
    System::Console::printLine(Language::Core::String("Received returned value: 54321"));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("=== All Tests Complete ==="));
}
