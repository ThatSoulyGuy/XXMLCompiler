...
int main() {
    ...
    System::Console::printLine(Language::Core::String("=== Testing Console Input ==="));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("Enter a line of text:"));
    Language::Runtime::Owned<Language::Core::String> line = System::Console::readLine();
    System::Console::print(Language::Core::String("You entered: "));
    System::Console::printLine(std::move(line));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("Enter an integer:"));
    Language::Runtime::Owned<Language::Core::Integer> num = System::Console::readInt();
    System::Console::print(Language::Core::String("You entered: "));
    System::Console::printLine(num->toString());
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("Enter a boolean (true/false or 1/0):"));
    Language::Runtime::Owned<Language::Core::Bool> boolVal = System::Console::readBool();
    System::Console::print(Language::Core::String("You entered: "));
    Language::Runtime::Owned<Language::Core::Integer> boolAsInt = boolVal->toInteger();
    System::Console::printLine(boolAsInt->toString());
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("=== Test completed! ==="));
}
