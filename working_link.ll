...
define i32 @main() #1 {
    ...
    %r4 = alloca ptr
    %r5 = load ptr, ptr %r0
    %r6 = call ptr @Integer_add(ptr %r5, ptr %r2)
    store ptr %r6, ptr %r4
    ...
    store ptr %r9, ptr %r7
    %r10 = call ptr @String_Constructor(ptr @.str.0)
    %r11 = call ptr @Console_printLine(ptr %r10)
    %r12 = call ptr @Console_printLine(ptr %r7)
    %r13 = call ptr @String_Constructor(ptr @.str.1)
