...
int main() {
    ...
    System::Console::printLine(Language::Core::String("=== Proof Test: Copy vs Reference ==="));
    Language::Runtime::Owned<Test::ValueChecker> checker = Test::ValueChecker();
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("COPY PARAMETER TEST:"));
    Language::Runtime::Owned<Language::Core::Integer> copyTest = Language::Core::Integer(42);
    System::Console::printLine(Language::Core::String("Before: ").append(copyTest->toString()));
    checker->modifyCopy(std::move(copyTest));
    System::Console::printLine(Language::Core::String("After:  ").append(copyTest->toString()));
    System::Console::printLine(Language::Core::String("Expected: 42 (unchanged)"));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("REFERENCE PARAMETER TEST:"));
    Language::Runtime::Owned<Language::Core::Integer> refTest = Language::Core::Integer(42);
    System::Console::printLine(Language::Core::String("Before: ").append(refTest->toString()));
    checker->modifyRef(std::move(refTest));
    System::Console::printLine(Language::Core::String("After:  ").append(refTest->toString()));
    System::Console::printLine(Language::Core::String("Expected: 777 (changed)"));
    System::Console::printLine(Language::Core::String(""));
