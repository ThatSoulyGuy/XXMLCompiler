...
// ============================================
int main() {
    System::PrintLine(String(String("Hello world!")));
}
    ...
    class String {
        ...
        public:
            ...
            String(void* cstr) {
                ...
                Syscall::memcpy(data, ptr, Integer(8));
            }
            void* toCString() {
                void* ptr = data;
            ...
            String append(String other) {
                ...
                Syscall::memcpy(data, newPtr, Integer(8));
                return this;
            }
            String copy() {
                ...
                Syscall::memcpy(result.data, newPtr, Integer(8));
                return result;
            }
            ...
            void dispose() {
                ...
                if (ptr != Integer(0)) {
                    ...
                    void* zero = Integer(0);
                    Syscall::memcpy(data, zero, Integer(8));
                }
            }
    };
