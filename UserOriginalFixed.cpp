...
namespace Hello {
    ...
    class MyClass {
        public:
            MyClass() = default;
            void someMethod(Language::Core::Integer myInt) {
                myInt = Language::Core::Integer(5);
            }
        private:
    };
...
int main() {
    ...
    Language::Runtime::Owned<Language::Core::Integer> num1 = Language::Core::Integer(56);
    Language::Runtime::Owned<Hello::MyClass> myClass = Hello::MyClass();
    System::Console::printLine(Language::Core::String("Hello world!").append(num1->toString()));
    myClass->someMethod(std::move(num1));
    System::Console::printLine(Language::Core::String("Hello world!").append(num1->toString()));
}
