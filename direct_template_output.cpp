...
// Instantiation: Test::Box<Integer>
class Test__Box_Integer {
    private:
        Language::Runtime::Owned<Language::Core::Integer> value;
    public:
        Test__Box_Integer() = default;
        Language::Runtime::Owned<Language::Core::Integer> getValue() {
            return value;
        }
        void setValue(Language::Runtime::Owned<Language::Core::Integer> val) {
...
int main() {
    ...
    Language::Runtime::Owned<Test__Box_Integer> box = Test__Box_Integer();
}
