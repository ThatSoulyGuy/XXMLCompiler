...
int main() {
    ...
    System::Console::printLine(Language::Core::String("=== XXML TEST SUITE ==="));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("--- Test 1: Integer ---"));
    ...
    Language::Runtime::Owned<Language::Core::Integer> prod = num1->multiply(num2);
    Language::Runtime::Owned<Language::Core::Integer> quot = num1->divide(num2);
    System::Console::printLine(Language::Core::String("Arithmetic: +, -, *, /"));
    Language::Runtime::Owned<Language::Core::Bool> eq = num1->equals(num2);
    Language::Runtime::Owned<Language::Core::Bool> lt = num2->lessThan(num1);
    Language::Runtime::Owned<Language::Core::Bool> gt = num1->greaterThan(num2);
    System::Console::printLine(Language::Core::String("Comparisons: ==, <, >"));
    System::Console::printLine(Language::Core::String("✓ Integer PASSED"));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("--- Test 2: Boolean ---"));
    Language::Runtime::Owned<Language::Core::Bool> t = Language::Core::Bool(true);
    Language::Runtime::Owned<Language::Core::Bool> f = Language::Core::Bool(false);
    Language::Runtime::Owned<Language::Core::Bool> andRes = t->and_(f);
    Language::Runtime::Owned<Language::Core::Bool> orRes = t->or_(f);
    Language::Runtime::Owned<Language::Core::Bool> notRes = t->not_();
    Language::Runtime::Owned<Language::Core::Bool> xorRes = t->xor_(f);
    System::Console::printLine(Language::Core::String("Logic: AND, OR, NOT, XOR"));
    System::Console::printLine(Language::Core::String("✓ Boolean PASSED"));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("--- Test 3: String ---"));
    Language::Runtime::Owned<Language::Core::String> s1 = Language::Core::String("Hello");
    Language::Runtime::Owned<Language::Core::String> s2 = Language::Core::String(" World");
    Language::Runtime::Owned<Language::Core::String> combined = s1->append(s2);
    Language::Runtime::Owned<Language::Core::Integer> len = combined->length();
    Language::Runtime::Owned<Language::Core::Bool> empty = combined->isEmpty();
    Language::Runtime::Owned<Language::Core::String> copy = combined->copy();
    Language::Runtime::Owned<Language::Core::Bool> strEq = combined->equals(copy);
    System::Console::printLine(Language::Core::String("Ops: append, length, isEmpty, copy, equals"));
    System::Console::printLine(Language::Core::String("✓ String PASSED"));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("--- Test 4: Ownership ---"));
    Language::Runtime::Owned<Language::Core::Integer> own1 = Language::Core::Integer(100);
    Language::Runtime::Owned<Language::Core::Integer> own2 = Language::Core::Integer(200);
    Language::Runtime::Owned<Language::Core::Bool> cmp = own1->equals(own2);
    System::Console::printLine(Language::Core::String("Owned (^) and Borrowed (&) semantics"));
    System::Console::printLine(Language::Core::String("✓ Ownership PASSED"));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("--- Test 5: Edge Cases ---"));
    Language::Runtime::Owned<Language::Core::Integer> zero = Language::Core::Integer(0);
    Language::Runtime::Owned<Language::Core::Integer> any = Language::Core::Integer(42);
    Language::Runtime::Owned<Language::Core::Integer> zSum = zero->add(any);
    System::Console::printLine(Language::Core::String("Zero: 0 + 42"));
    Language::Runtime::Owned<Language::Core::Integer> neg = Language::Core::Integer(-42);
    System::Console::printLine(Language::Core::String("Negative: -42"));
    Language::Runtime::Owned<Language::Core::String> emptyStr = Language::Core::String("");
    Language::Runtime::Owned<Language::Core::Bool> isEmpty = emptyStr->isEmpty();
    System::Console::printLine(Language::Core::String("Empty string"));
    System::Console::printLine(Language::Core::String("✓ Edge Cases PASSED"));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("--- Test 6: Nested Ops ---"));
    Language::Runtime::Owned<Language::Core::Integer> a = Language::Core::Integer(10);
    Language::Runtime::Owned<Language::Core::Integer> b = Language::Core::Integer(20);
    Language::Runtime::Owned<Language::Core::Integer> c = Language::Core::Integer(2);
    Language::Runtime::Owned<Language::Core::Integer> ab = a->add(b);
    Language::Runtime::Owned<Language::Core::Integer> result = ab->multiply(c);
    System::Console::printLine(Language::Core::String("(10 + 20) * 2 = 60"));
    Language::Runtime::Owned<Language::Core::Integer> x = Language::Core::Integer(5);
    Language::Runtime::Owned<Language::Core::Integer> y = Language::Core::Integer(15);
    Language::Runtime::Owned<Language::Core::Integer> z = Language::Core::Integer(25);
    Language::Runtime::Owned<Language::Core::Bool> xy = x->lessThan(y);
    Language::Runtime::Owned<Language::Core::Bool> yz = y->lessThan(z);
    Language::Runtime::Owned<Language::Core::Bool> both = xy->and_(yz);
    System::Console::printLine(Language::Core::String("(5<15) AND (15<25) = true"));
    System::Console::printLine(Language::Core::String("✓ Nested Ops PASSED"));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("╔══════════════════════════════════════╗"));
    System::Console::printLine(Language::Core::String("║   ALL TESTS PASSED! ✓✓✓             ║"));
    System::Console::printLine(Language::Core::String("╚══════════════════════════════════════╝"));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("Features Tested:"));
    ...
    System::Console::printLine(Language::Core::String("  ✓ String (append, length, copy)"));
    System::Console::printLine(Language::Core::String("  ✓ Ownership (^, &)"));
