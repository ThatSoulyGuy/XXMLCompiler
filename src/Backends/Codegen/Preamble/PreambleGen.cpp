...
void PreambleGen::emitProcessorAPI(std::stringstream& out) const {
    ...
    out << "declare ptr @xxml_Processor_getTargetKind(ptr)\n";
    out << "declare ptr @xxml_Processor_getTargetName(ptr)\n";
    out << "declare ptr @xxml_Processor_getTypeName(ptr)\n";
    out << "declare ptr @xxml_Processor_getClassName(ptr)\n";
    out << "declare ptr @xxml_Processor_getNamespaceName(ptr)\n";
    out << "declare ptr @xxml_Processor_getSourceFile(ptr)\n";
    out << "declare i64 @xxml_Processor_getLineNumber(ptr)\n";
    out << "declare i64 @xxml_Processor_getColumnNumber(ptr)\n";
    out << "declare i64 @xxml_Processor_getPropertyCount(ptr)\n";
    out << "declare ptr @xxml_Processor_getPropertyNameAt(ptr, i64)\n";
    out << "declare ptr @xxml_Processor_getPropertyTypeAt(ptr, i64)\n";
    out << "declare ptr @xxml_Processor_getPropertyOwnershipAt(ptr, i64)\n";
    out << "declare i64 @xxml_Processor_getMethodCount(ptr)\n";
    out << "declare ptr @xxml_Processor_getMethodNameAt(ptr, i64)\n";
    out << "declare ptr @xxml_Processor_getMethodReturnTypeAt(ptr, i64)\n";
    out << "declare i64 @xxml_Processor_hasMethod(ptr, ptr)\n";
    out << "declare i64 @xxml_Processor_hasProperty(ptr, ptr)\n";
    out << "declare ptr @xxml_Processor_getBaseClassName(ptr)\n";
    out << "declare i64 @xxml_Processor_isClassFinal(ptr)\n";
    out << "declare i64 @xxml_Processor_getParameterCount(ptr)\n";
    out << "declare ptr @xxml_Processor_getParameterNameAt(ptr, i64)\n";
    out << "declare ptr @xxml_Processor_getParameterTypeAt(ptr, i64)\n";
    out << "declare ptr @xxml_Processor_getReturnTypeName(ptr)\n";
    out << "declare i64 @xxml_Processor_isMethodStatic(ptr)\n";
    out << "declare i64 @xxml_Processor_hasDefaultValue(ptr)\n";
    out << "declare ptr @xxml_Processor_getOwnership(ptr)\n";
    out << "declare ptr @xxml_Processor_getTargetValue(ptr)\n";
    out << "declare i64 @xxml_Processor_hasTargetValue(ptr)\n";
    out << "declare i64 @xxml_Processor_getTargetValueType(ptr)\n";
    out << "declare void @xxml_Processor_message(ptr, ptr)\n";
    out << "declare void @xxml_Processor_warning(ptr, ptr)\n";
    out << "declare void @xxml_Processor_warningAt(ptr, ptr, ptr, i64, i64)\n";
    out << "declare void @xxml_Processor_error(ptr, ptr)\n";
    out << "declare void @xxml_Processor_errorAt(ptr, ptr, ptr, i64, i64)\n";
    out << "declare ptr @xxml_Processor_argGetName(ptr)\n";
    out << "declare i64 @xxml_Processor_argAsInt(ptr)\n";
    out << "declare ptr @xxml_Processor_argAsString(ptr)\n";
    out << "declare i64 @xxml_Processor_argAsBool(ptr)\n";
    out << "declare double @xxml_Processor_argAsDouble(ptr)\n";
    out << "declare i64 @xxml_Processor_getArgCount(ptr)\n";
    out << "declare ptr @xxml_Processor_getArgAt(ptr, i64)\n";
    out << "declare ptr @xxml_Processor_getArg(ptr, ptr)\n";
    out << "declare i64 @xxml_Processor_getAnnotationArgCount(ptr)\n";
    out << "declare ptr @xxml_Processor_getAnnotationArg(ptr, ptr)\n";
    out << "declare ptr @xxml_Processor_getAnnotationArgNameAt(ptr, i64)\n";
    out << "declare i64 @xxml_Processor_getAnnotationArgTypeAt(ptr, i64)\n";
    out << "declare i64 @xxml_Processor_hasAnnotationArg(ptr, ptr)\n";
    out << "declare i64 @xxml_Processor_getAnnotationIntArg(ptr, ptr, i64)\n";
