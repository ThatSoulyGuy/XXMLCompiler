...
define i32 @main() #1 {
    ...
    %r13 = alloca ptr
    ; DEBUG: Tracking variable deez (%r13) as type: List<Integer>
    %r14 = call ptr @List_Constructor()
    ; DEBUG: Registered %r14 -> List
    store ptr %r14, ptr %r13
    ; Instantiate owned variable: nutz
    %r15 = alloca ptr
    ; DEBUG: Tracking variable nutz (%r15) as type: MyNamespace::SomeClass<MyNamespace::MyClass>
    ; instance method call on expression with unknown type
    ...
    ; DEBUG: Found instance type: List<Integer>
    ; DEBUG: Extracted element type: Integer
    ; DEBUG: Registered %r40 -> Integer
    %r41 = call ptr @Integer_toString(ptr %r40)
    ; DEBUG: Registered %r41 -> Integer
