...
; ============================================
@.str.0 = private unnamed_addr constant [25 x i8] c"Namespace test complete!\00"
...
; Class: TestClass
; ============================================
%class.TestClass = type { i8 }

; Constructor for TestClass
define ptr @TestClass_Constructor(ptr %this) #1 {
    ret ptr %this
}

; Method: getValue
define ptr @TestClass_getValue(ptr %this) #1 {
...
define i32 @main() #1 {
    ...
    store ptr null, ptr %r1
    ; Instantiate owned variable: val
    %r2 = alloca ptr
    %r3 = load ptr, ptr %r1
    %r4 = call ptr @TestClass_getValue(ptr %r3)
    store ptr %r4, ptr %r2
    %r5 = call ptr @String_Constructor(ptr @.str.0)
    %r6 = call ptr @Console_printLine(ptr %r5)
