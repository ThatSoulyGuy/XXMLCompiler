...
int main() {
    ...
    System::Console::printLine(Language::Core::String("=== Comprehensive Console Input Test ==="));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("1. Enter your name:"));
    Language::Runtime::Owned<Language::Core::String> name = System::Console::readLine();
    System::Console::print(Language::Core::String("   Hello, "));
    System::Console::printLine(std::move(name));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("2. Enter your age:"));
    Language::Runtime::Owned<Language::Core::Integer> age = System::Console::readInt();
    System::Console::print(Language::Core::String("   You are "));
    System::Console::print(age->toString());
    System::Console::printLine(Language::Core::String(" years old"));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("3. Do you like programming? (true/false):"));
    Language::Runtime::Owned<Language::Core::Bool> likesProgramming = System::Console::readBool();
    Language::Runtime::Owned<Language::Core::Integer> boolAsInt = likesProgramming->toInteger();
    System::Console::print(Language::Core::String("   Answer: "));
    System::Console::printLine(boolAsInt->toString());
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("4. Enter a single character:"));
    Language::Runtime::Owned<Language::Core::String> character = System::Console::readChar();
    System::Console::print(Language::Core::String("   You entered: '"));
    System::Console::print(std::move(character));
    System::Console::printLine(Language::Core::String("'"));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("=== All tests completed successfully! ==="));
}
