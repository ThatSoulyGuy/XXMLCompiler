...
int main() {
    ...
    System::Console::printLine(Language::Core::String("=== Testing Updated Standard Library ==="));
    System::Console::printLine(Language::Core::String(""));
    Language::Runtime::Owned<Language::Core::Integer> num1 = Language::Core::Integer(42);
    Language::Runtime::Owned<Language::Core::Integer> num2 = Language::Core::Integer(8);
    System::Console::printLine(Language::Core::String("Created two integers: 42 and 8"));
    Language::Runtime::Owned<Language::Core::Bool> flag = Language::Core::Bool(true);
    System::Console::printLine(Language::Core::String("Created boolean: true"));
    Language::Runtime::Owned<Language::Core::String> greeting = Language::Core::String("Hello XXML!");
    System::Console::printLine(Language::Core::String("Created string successfully"));
    System::Console::printLine(Language::Core::String(""));
