...
define ptr @SomeClass_run(ptr %this) #1 {
    ...
    %r1 = call ptr @Console_printLine(ptr null)
...
define i32 @main() #1 {
    ...
    ; complex instance method call (not yet supported)
    %r17 = call ptr @Console_printLine(ptr null)
    ...
    ; complex instance method call (not yet supported)
    %r28 = call ptr @Console_printLine(ptr null)
    ; complex instance method call (not yet supported)
    %r29 = call ptr @Console_printLine(ptr null)
