...
int main() {
    ...
    System::Console::printLine(Language::Core::String("=== Testing Import System ==="));
    System::Console::printLine(Language::Core::String(""));
    Language::Core::Integer a = Language::Core::Integer(10);
    Language::Core::Integer b = Language::Core::Integer(5);
    System::Console::print(Language::Core::String("Created: a=10, b=5"));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("=== Import Test Complete! ==="));
}
