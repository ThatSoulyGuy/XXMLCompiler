...
if_end5:
            ...
            %14 = load i64, ptr %7
            %15 = mul i64 %14, 8
            %16 = call ptr @xxml_malloc(ptr %15)
            store ptr %16, ptr %13
...
if_then6:
                ...
                %24 = mul i64 %23, 8
                call void @xxml_memcpy(ptr %20, ptr %21, ptr %24)
...
if_end8:
                  ...
                  %27 = load ptr, ptr %13
                  call void @xxml_memcpy(ptr %26, ptr %27, ptr 8)
                  %28 = getelementptr inbounds %class.List_Integer, ptr %this, i32 0, i32 1
                  %29 = load ptr, ptr %7
                  call void @xxml_memcpy(ptr %28, ptr %29, ptr 8)
                br label %if_end2
if_else1:
                  br label %if_end2
if_end2:
                    ...
                    %45 = load ptr, ptr %39
                    call void @xxml_memcpy(ptr %44, ptr %45, ptr 8)
                    ret void
                  }
...
if_end20:
                                          ...
                                          define void @List_Integer_clear(ptr %this) #1 {
                                            ...
                                            %2 = getelementptr inbounds %class.List_Integer, ptr %this, i32 0, i32 2
                                            %3 = load ptr, ptr %1
                                            call void @xxml_memcpy(ptr %2, ptr %3, ptr 8)
                                            ret void
                                          }
...
while_end29:
                                                              ...
                                                              %49 = load ptr, ptr %42
                                                              call void @xxml_memcpy(ptr %48, ptr %49, ptr 8)
                                                              ret void
                                                            }
...
if_then30:
                                                                  ...
                                                                  %7 = load ptr, ptr %5
                                                                  call void @xxml_memcpy(ptr %6, ptr %7, ptr 8)
                                                                br label %if_end32
if_else31:
                                                                  br label %if_end32
if_end32:
                                                                    ...
                                                                    %9 = getelementptr inbounds %class.List_Integer, ptr %this, i32 0, i32 2
                                                                    %10 = load ptr, ptr %8
                                                                    call void @xxml_memcpy(ptr %9, ptr %10, ptr 8)
                                                                    %11 = getelementptr inbounds %class.List_Integer, ptr %this, i32 0, i32 1
                                                                    %12 = load ptr, ptr %8
                                                                    call void @xxml_memcpy(ptr %11, ptr %12, ptr 8)
                                                                    ret void
                                                                  }
