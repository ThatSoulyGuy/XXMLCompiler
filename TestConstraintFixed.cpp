...
class Executor_Runner {
    public:
        ...
        Language::Runtime::Owned<Language::Core::Integer> executeWith(Language::Runtime::Owned<Runner> runner) {
            return runner->run();
        }
};
...
int main() {
    ...
    Language::Runtime::Owned<Executor_Runner> executor = Executor_Runner();
    Language::Runtime::Owned<Runner> runner = Runner();
    Language::Runtime::Owned<Language::Core::Integer> result = executor->executeWith(std::move(runner));
}
