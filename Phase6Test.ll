...
; Constructor for Box
define ptr @Box_Constructor(ptr %this) {
    ret ptr %this
}

; Method: setValue
define void @Box_setValue(ptr %this, ptr %val) {
    ; Error: variable value not found
    ret void
}

; Method: getValue
define ptr @Box_getValue(ptr %this) {
    value
}


define i32 @main() {
    ; Instantiate owned variable: myBox
    %r0 = alloca ptr
    %r1 = call ptr @Box_Constructor()
    store ptr %r1, ptr %r0
    ...
    store ptr %r3, ptr %r2
    %r4 = load ptr, ptr %r0
    %r5 = call ptr @Box_setValue(ptr %r4, ptr %r2)
