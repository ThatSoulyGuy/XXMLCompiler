...
define ptr @List_Integer_Constructor(ptr %this) #1 {
  ...
  %r0 = call ptr @xxml_memcpy(ptr %3, ptr %1, i64 8)
  %4 = getelementptr inbounds %class.List_Integer, ptr %this, i32 0, i32 1
  %r1 = call ptr @xxml_memcpy(ptr %4, ptr %2, i64 8)
  %5 = getelementptr inbounds %class.List_Integer, ptr %this, i32 0, i32 2
  %r2 = call ptr @xxml_memcpy(ptr %5, ptr %2, i64 8)
  ret ptr %this
}
...
if_end8:
                  ...
                  %r5 = call ptr @xxml_memcpy(ptr %25, ptr %13, i64 8)
                  %26 = getelementptr inbounds %class.List_Integer, ptr %this, i32 0, i32 1
                  %r6 = call ptr @xxml_memcpy(ptr %26, ptr %7, i64 8)
                br label %if_end2
if_else1:
                  br label %if_end2
if_end2:
                    ...
                    %29 = getelementptr inbounds %class.List_Integer, ptr %this, i32 0, i32 2
                    ...
                    store ptr %34, ptr %27
                    %35 = load ptr, ptr %27
                    call void @xxml_ptr_write(ptr %35, ptr %35)
                    ; Instantiate owned variable: newCount
                    %36 = alloca i64
                    %37 = getelementptr inbounds %class.List_Integer, ptr %this, i32 0, i32 2
                    %38 = ptrtoint ptr %37 to i64
                    %39 = add i64 %38, 1
                    %40 = inttoptr i64 %39 to ptr
                    store ptr %40, ptr %36
                    %41 = getelementptr inbounds %class.List_Integer, ptr %this, i32 0, i32 2
                    %r7 = call ptr @xxml_memcpy(ptr %41, ptr %36, i64 8)
                    ret void
                  }
...
if_end20:
                                          ...
                                          define void @List_Integer_clear(ptr %this) #1 {
                                            ...
                                            store i64 0, ptr %1
                                            %2 = getelementptr inbounds %class.List_Integer, ptr %this, i32 0, i32 2
                                            %r15 = call ptr @xxml_memcpy(ptr %2, ptr %1, i64 8)
                                            ret void
                                          }
...
while_body28:
                                                              ...
                                                              %37 = load ptr, ptr %18
                                                              %38 = load i64, ptr %35
                                                              call void @xxml_ptr_write(ptr %37, ptr %38)
                                                              ; Move nextIdx to i
                                                              %39 = load i64, ptr %25
                                                              store i64 %39, ptr %12
                                                              br label %while_cond27
while_end29:
                                                              ...
                                                              %r18 = call ptr @xxml_memcpy(ptr %47, ptr %41, i64 8)
                                                              ret void
                                                            }
...
if_then30:
                                                                  ...
                                                                  %r19 = call ptr @xxml_memcpy(ptr %6, ptr %5, i64 8)
                                                                br label %if_end32
if_else31:
                                                                  br label %if_end32
if_end32:
                                                                    ...
                                                                    %r20 = call ptr @xxml_memcpy(ptr %8, ptr %7, i64 8)
                                                                    %9 = getelementptr inbounds %class.List_Integer, ptr %this, i32 0, i32 1
                                                                    %r21 = call ptr @xxml_memcpy(ptr %9, ptr %7, i64 8)
                                                                    ret void
                                                                  }
                                                                  ...
                                                                  define i32 @main() #1 {
                                                                    ...
                                                                    call void @List_Integer_add(ptr %4, ptr %5)
                                                                    %6 = load ptr, ptr %0
                                                                    %r24 = call ptr @Integer_Constructor(i64 12)
                                                                    %7 = inttoptr i64 6 to ptr
                                                                    %8 = inttoptr i64 12 to ptr
                                                                    call void @List_Integer_add(ptr %7, ptr %8)
                                                                    %9 = load ptr, ptr %0
                                                                    %r25 = call ptr @Integer_Constructor(i64 55)
                                                                    %10 = inttoptr i64 9 to ptr
                                                                    %11 = inttoptr i64 55 to ptr
                                                                    call void @List_Integer_add(ptr %10, ptr %11)
                                                                    %12 = load ptr, ptr %0
                                                                    %r26 = call ptr @Integer_Constructor(i64 24)
                                                                    %13 = inttoptr i64 12 to ptr
                                                                    %14 = inttoptr i64 24 to ptr
                                                                    call void @List_Integer_add(ptr %13, ptr %14)
                                                                    %15 = load ptr, ptr %0
                                                                    %r27 = call ptr @Integer_Constructor(i64 92)
                                                                    %16 = inttoptr i64 15 to ptr
                                                                    %17 = inttoptr i64 92 to ptr
                                                                    call void @List_Integer_add(ptr %16, ptr %17)
                                                                    %18 = load ptr, ptr %0
                                                                    %r28 = call ptr @Integer_Constructor(i64 37)
                                                                    %19 = inttoptr i64 18 to ptr
                                                                    %20 = inttoptr i64 37 to ptr
                                                                    call void @List_Integer_add(ptr %19, ptr %20)
                                                                    %21 = load ptr, ptr %0
                                                                    %r29 = call ptr @Integer_Constructor(i64 19)
                                                                    %22 = inttoptr i64 21 to ptr
                                                                    %23 = inttoptr i64 19 to ptr
                                                                    call void @List_Integer_add(ptr %22, ptr %23)
                                                                    %24 = alloca i64
                                                                    %r30 = call ptr @Integer_Constructor(i64 0)
                                                                    store i64 0, ptr %24
                                                                    %25 = load ptr, ptr %0
                                                                    %26 = inttoptr i64 25 to ptr
                                                                    %r31 = call ptr @List_Integer_size(ptr %26)
                                                                    %27 = alloca i64
                                                                    store i64 0, ptr %27
                                                                    br label %for_cond33
for_cond33:
                                                                        %28 = load i64, ptr %24
                                                                        %29 = load i64, ptr %27
                                                                        %30 = call i1 @@Integer_lt(i64 %28, i64 %29)
                                                                        br i1 %30, label %for_body34, label %for_end36
for_body34:
                                                                          %31 = load ptr, ptr %12
                                                                          %32 = inttoptr i64 31 to ptr
                                                                          %r32 = call ptr @List_Integer_toString(ptr %32)
                                                                          %33 = inttoptr i64 0 to ptr
                                                                          call void @Console_printLine(ptr %33)
                                                                          br label %for_incr35
for_incr35:
                                                                            %34 = load i64, ptr %24
                                                                            %35 = call ptr @@Integer_Constructor(i64 1)
                                                                            %36 = call ptr @@Integer_add(i64 %34, ptr %35)
                                                                            store ptr %36, ptr %24
                                                                            br label %for_cond33
for_end36:
                                                                            ret i32 0
