...
namespace Language::Core {
    ...
    Language::Runtime::Owned<Language::Core::String> Language::Core::Integer::toString() {
        Language::Runtime::Owned<int64_t> v(value.get());
        Language::Runtime::Owned<const void*> str = Syscall::int_to_string(v);
...
int main() {
    ...
    System::Console::printLine(Language::Core::String("=== Integer to String Test ==="));
    System::Console::printLine(Language::Core::String(""));
    Language::Runtime::Owned<Language::Core::Integer> num1 = Language::Core::Integer(42);
    Language::Runtime::Owned<Language::Core::String> str1 = num1->toString();
    System::Console::printLine(Language::Core::String("Converted 42 to string"));
    Language::Runtime::Owned<Language::Core::Integer> zero = Language::Core::Integer(0);
    Language::Runtime::Owned<Language::Core::String> strZero = zero->toString();
    System::Console::printLine(Language::Core::String("Converted 0 to string"));
    Language::Runtime::Owned<Language::Core::Integer> negative = Language::Core::Integer(-123);
    Language::Runtime::Owned<Language::Core::String> strNeg = negative->toString();
    System::Console::printLine(Language::Core::String("Converted -123 to string"));
    Language::Runtime::Owned<Language::Core::Integer> count = Language::Core::Integer(5);
    Language::Runtime::Owned<Language::Core::String> prefix = Language::Core::String("Count: ");
    Language::Runtime::Owned<Language::Core::String> countStr = count->toString();
    Language::Runtime::Owned<Language::Core::String> message = prefix->append(countStr);
    System::Console::printLine(Language::Core::String("Built message with count"));
    System::Console::printLine(Language::Core::String(""));
    System::Console::printLine(Language::Core::String("✓ All conversions successful!"));
}
